...
{
	public static String AUC_URL; // configured by FesApplicaiton//"http://127.0.0.1:8090/AUC";
	...
	public JSONObject sendGet(Map<String, String> headerParams, JSONObject postParams) {
